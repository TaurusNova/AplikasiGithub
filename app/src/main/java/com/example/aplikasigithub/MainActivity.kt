...
class MainActivity : AppCompatActivity() {
                ...
                when{
                    response.isSuccessful ->
                            when{
                                ...
                                else -> tampilToast(applicationContext, "Berhasil")
                            }
                    else -> tampilToast(applicationContext, "Gagal")
                }
            }
        })
    ...
    private fun  tampilGithubUser(githubUser: List<GithubUser>){
        ...
        listGithubUser.adapter = GithubUserAdapter(this, githubUser) {githubUser
            val github = it
